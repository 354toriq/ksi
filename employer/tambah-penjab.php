	...
	<div class="panel-body">
			...
			<div class="form-group"><label for="editor1">Telp.</label><input type="text" class="form-control" name="telp" required placeholder='Telp. '></div>
	...
	{
		$query 		= "SELECT MAX(RIGHT(id_penjab, 4)) as max_id FROM penjab ORDER BY id_penjab"; 
		...
		$move			= 	move_uploaded_file($_FILES['foto']['tmp_name'], $datafoto);
		//echo $isi;
