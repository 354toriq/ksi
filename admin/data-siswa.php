...
<head>
    <meta charset="UTF-8">
    <title>Administrator | Siswa</title>
			...
			<?php include 'include/header.php'; ?>
				...
				<div class="table-responsive">
					...
					<?php
						...
						$querysis		=	mysql_query("select * from siswa");
						...
						{		
								...
								$querysekolah 		= 	mysql_query("select * from sekolah where id_sekolah = '$idsklh' ");
								...
								echo "<th><a href='data-penjab.php?detail=$penjab->id_penjab' >$penjab->nama</a></th>";
