    ...
    <h3 class="panel-title">Detail Paket Kesetaaan</h3>
	</div>
	<div class="panel-body">
	


			<div class="form-group"><label for="editor1">ID Paket</label><input type="text" class="form-control" name="idpaket" value="<?=$paket->id_paket?>"></div>
			<div class="form-group"><label for="editor1">Nama Paket</label><input type="text" class="form-control" name="nama" value="<?=$paket->nama?>"></div>
			<div class="form-group"><label for='alamat'>Keterangan</label><br><textarea class="form-control" id="alamat" name="ket" rows="10"><?=$paket->keterangan?></textarea></div>
