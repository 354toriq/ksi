...
<head>
    <meta charset="UTF-8">
    <title>Administrator | Paket Pembelajaran</title>
    ...
    <meta name="keywords" content="Admin, Bootstrap 3, Template, Theme, Responsive">
      ...
      <body class="skin-black">
			...
			<?php include 'include/header.php'; ?>
				...
				<div class="panel-heading"><strong>Data Paket Belajar</strong></div>
				...
				<div class="table-responsive">
					...
					<?php
						...
						{		
								...
								echo "<a href='?hapus=$idpaket' "; 
								?>
								onclick='return confirm("Yakin menghapus data paket belajar ini?")'
								<?php
					...
					{
						$idpaket		=	$_GET['hapus'];
						$queryhapus		=	mysql_query("DELETE FROM `paket` WHERE `id_paket` = '$idpaket';");
						if($queryhapus)
						{
							echo '
