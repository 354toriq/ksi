	...
	<div class="panel-body">
			...
			<select name="idsekolah" class="form-control">
				<?php 	$querysekolah 	= mysql_query("select * from sekolah");
	...
	if(isset($_POST['simpan']))
	{
			...
			$sql 		=	"select max(id_siswa) as id from siswa where id_sekolah like '%$idsekolah%'";
			$query		=	mysql_query($sql);
			$data		=	mysql_fetch_array($query);
			$kodeawal	=	substr($data['id'],9,8);//ambil string mulai dari karakter ke 10 sampe 8 digit ke belakang
